...
import { AssignmentExpr, BinaryExpr, BooleanExpr, CallExpr, FunctionDeclaration, Identifier, IfStatement, NumericLiteral, ObjectLiteral, Program, Stmt, VarDecleration } from "../frontend/ast.ts";
import Environment from "./environment.ts";
import { eval_identifier, eval_binary_expr, eval_assignment, eval_object_expr, eval_call_expr, eval_boolean_expr } from "./eval/expressions.ts";
